  ...
  return (
    ...
    <nav className="bg-white sticky top-0 z-50 w-full shadow-md">
      ...
      <div className="max-w-[1450px] w-[90%] mx-auto flex justify-between items-center py-5">
        ...
        {/* Desktop Navigation Links - Hides below 810px */}

        <ul className="flex gap-10 items-center max-[810px]:hidden text-gray-800">
        ...
        <div className="flex justify-center items-center gap-4">
          ...
          <div className="max-[900px]:hidden flex gap-3">
          ...
          {/* Corrected: Hamburger Menu Icon - Visible below 900px */}

          <div

            className="min-[900px]:hidden text-3xl cursor-pointer text-black"
